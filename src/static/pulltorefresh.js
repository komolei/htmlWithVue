(function (global, factory) {
  ...
  function _ptrMarkup() {
    return `<div class=\"__PREFIX__box\">  <div class=\"__PREFIX__content\">  
...
</svg>   <div class=\"__PREFIX__text\"></div>  </div></div>`;
  }

  function _ptrStyles() {
    return `.__PREFIX__ptr {  pointer-events: none;  font-size: 0.85em; 
       font-weight: bold;  top: 0;  height: 0;  transition: height 0.3s, min-height 0.3s; 
        text-align: center;  width: 100%;  overflow: hidden;  display: flex;  align-items: 
        flex-end;  align-content: stretch;}.__PREFIX__box {  padding: 10px;  flex-basis: 100%;}
        .__PREFIX__pull {  transition: none;}.__PREFIX__text {  margin-top: 0.33em;  color: rgba(0, 0, 0, 0.3);}
       `;
  }
  ...
  var _defaults = {
    ...
    instructionsReleaseToRefresh: '加载中...',
